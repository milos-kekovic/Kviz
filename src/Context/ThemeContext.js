...
export const DarkTheme = {
  ...
  buttonBackgroundColorPrimary: Colors.darkBrown,
  buttonBackgroundColorSecondary: Colors.beige,
  buttonTextColor: Colors.darkBrown,
  buttonTextColorPrimary: Colors.beige,
  buttonTextColorSecondary: Colors.darkBrown,
